                    ...
                    <div class="card-body">
                        <form action="{{ route('category.update', $category->id) }}" method="post" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                ...
                                <input name="keyword" type="text" class="form-control @error('keyword') is-invalid @enderror" value="{{ $category->keyword }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" name="status">
                                  <option value="1"  @php echo ($category['status'] == '1') ? 'selected' : ''; @endphp>Kích hoạt</option>
                                  <option value="0"  @php echo ($category['status'] == '0') ? 'selected' : ''; @endphp>Không</option>
                                </select>
                              </div>
                            <div>
